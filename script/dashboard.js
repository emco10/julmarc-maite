...
const mensajes = [
    ...
    "Eres el lugar donde mi corazón descansa.",
    "Contigo aprendí que el amor no es intensidad, es paz… y tú eres mi paz favorita.",
    "Si tuviera que elegir un recuerdo para repetir siempre, sería cualquier momento a tu lado.",
    "No quiero prometerte el mundo, quiero construirlo contigo paso a paso.",
    "Eres mi casualidad más hermosa y mi decisión más segura.",
    "Gracias por existir justo cuando mi vida necesitaba algo tan bonito como tú.",
    "No sabía que alguien podía convertirse en hogar… hasta que me abrazaste.",
    "Lo mejor de mis días no es lo que hago, es saber que te tengo.",
    "Te elijo hoy, mañana y cada día que el calendario quiera regalarnos."
];
